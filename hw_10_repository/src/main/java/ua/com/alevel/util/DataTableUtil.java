...
public final class DataTableUtil {
    ...
    public static <T extends BaseEntity> DataTableResponse<T> responsePageToDTResponse(Page<T> responsePage, DataTableRequest request) {
        ...
        dataTableResponse.seteListSize(responsePage.getTotalElements());
        dataTableResponse.setTotalPageSize(responsePage.getTotalPages());
        dataTableResponse.seteList(responsePage.getContent());
